...
class ProductsDAO {
  ...
  static async postProduct(
    ...
    return await ProductsRepository.postProduct(
      title,
      url,
      itemUrl,
      description,
  ...
  static async getProductFromCategory(title: string) {
    try {
      ...
      const query = await ProductsRepository.getProductFromCategory(
        category_id
      );
      return query;
    } catch (error) {
  ...
  static async updateProductById(
    ...
    try {
      ...
      return await ProductsRepository.updateProductById(
        id,
        title,
        url,
        description
  ...
  static async updateProductByIdWithoutUrl(
    id: number,
    title: string,
    description: string
  ) {
    try {
      ...
      return await ProductsRepository.updateProductByIdWithoutUrl(
        id,
        title,
        description
      );
